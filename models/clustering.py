...
def cluster(features, num_cluster):
    ...
    niter = max(25, int(20 * (nsample / (1000 * num_cluster)))) # As a rule of thumb there is no consistent improvement of the k-means quantizer beyond 20 iterations and 1000 * k training points
    # faiss implementation of k-means
    clus = faiss.Kmeans(d, num_cluster, gpu=True, spherical=True, seed=42, niter=niter, verbose=True)
